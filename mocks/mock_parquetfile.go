...
import (
	...
	ParquetFile "github.com/xitongsys/parquet-go/ParquetFile"
	reflect "reflect"
)
...
func (m *MockParquetFile) Open(name string) (ParquetFile.ParquetFile, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Open", name)
	ret0, _ := ret[0].(ParquetFile.ParquetFile)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockParquetFile) Create(name string) (ParquetFile.ParquetFile, error) {
	m.ctrl.T.Helper()
